...
$lvl=3;
    ...
    {
        if($_POST['answer']=="berkshirehathaway")
        {
            $_SESSION["lvl"] = 4;
            $d = date("Y-m-d G:i:s");
    ...
    <body>
        ...
        <section class="my-first">
            <div class="my-question">
                <h1 class="my-heading">Level 3</h1>
                <p>
                    <a href="http://cypher.thematrixclan.com/files/get_rekt_tum_sai_na_ho_paega.rar">Clue</a>
                </p>
                <form action="http://cypher.thematrixclan.com/level3.php" method="post">

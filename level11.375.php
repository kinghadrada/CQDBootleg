...
$lvl=11.375;
    ...
    {
        if($_POST['answer']=="sdnkjdnfgjlkjskgjjljflNOANSWERTOTHISLEVELLOL")
        {
            $_SESSION["lvl"] = 12;
            $d = date("Y-m-d G:i:s");
    ...
    <head>
        <meta charset="UTF-8">
        <title>Cypher | Level 11.375</title>
    ...
    <body>
        ...
        <section class="my-first">
            <div class="my-question">
                <h1 class="my-heading">Level 11.375</h1>
                <p>
                You are Warren buffett. What would you do?
                </p>
                <form action="http://cypher.thematrixclan.com/level11.375.php" method="post">

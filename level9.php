...
$lvl=9;
    ...
    <head>
        <meta charset="UTF-8">
        <title>Cypher | Level 9</title>
        <link rel="icon" href="favicon.png">
        <link rel="stylesheet" href="css/levels.css">
        <script src="http://cypher.thematrixclan.com/hint.js"></script>
    ...
    <body>
        ...
        <section class="my-first">
            <div class="my-question">
                <h1 class="my-heading">Level 9</h1>
                <p>
                He rarely gives anyone TLC.<br /><br />His behaviour would make one beat the bejesus out of him in a TLC match.<br /><br />He also acquired TLC.<br /><br />TLC isn't thin layer chromatography in any one of the above mentioned TLCs.<br /><br />TLC.<br /><br />
		<img src="http://cypher.thematrixclan.com/files/lolk.jpg">
                </p>
                <form action="http://cypher.thematrixclan.com/level9.php" method="post">

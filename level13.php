    ...
    <body>
        ...
        <section class="my-first">
            <div class="my-question">
                <h1 class="my-heading">Level 13</h1>
                <p>
                <a href="http://cypher.thematrixclan.com/files/toh-kaise-hain-aap-log.rar">Clue</a>
                </p>
                <form action="http://cypher.thematrixclan.com/level13.php" method="post">

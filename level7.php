    ...
    <body>
        ...
        <section class="my-first">
            <div class="my-question">
                <h1 class="my-heading">Level 7</h1>
                <p>
                    <a href = "http://cypher.thematrixclan.com/files/sometimes_I_rip_my_pants_off_and_call_everything_a_dogger.rar">Clue</a>
                </p>
                <form action="http://cypher.thematrixclan.com/level7.php" method="post">

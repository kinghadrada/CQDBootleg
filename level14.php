...
$lvl=14;
    ...
    {
        if(($_POST['answer']=="impossibletrinity")||($_POST['answer']=="trilemma"))
        {
            $_SESSION["lvl"] = 15;
            $d = date("Y-m-d G:i:s");
    ...
    <body>
        ...
        <section class="my-first">
            <div class="my-question">
                <h1 class="my-heading">Level 14</h1>
                <p>
                <a href="http://cypher.thematrixclan.com/files/Level15.rar">Clue</a>
                </p>
                <form action="http://cypher.thematrixclan.com/level14.php" method="post">

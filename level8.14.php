    ...
    <body>
        ...
        <section class="my-first">
            <div class="my-question">
                <h1 class="my-heading">Level 8.14</h1>
                <p>
                    Password: 5247
                </p>
                <form action="http://cypher.thematrixclan.com/level8.14.php" method="post">
                    <input class="<?php echo htmlentities($check)?>" type="text" autocomplete="off" name="answer" placeholder="Username" />
